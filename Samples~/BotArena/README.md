...
Bot Arena is the advanced ABC 2.0 sample. It is a complete top-down shooter made with Unity built-ins and no external art, input, inspector, or runtime packages.
...
| Reusable authoring | `Resources/BotBlueprint` supplies independent bot data instances |
...
| Runtime visibility | The HUD and ABC Dashboard expose live counts |
